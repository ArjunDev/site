...
const Home = () => {
  return (
    <div className='flex justify-center items-center flex-col w-full h-auto gap-4 bg-gray-100 font-mono sm:w-full sm:min-h-screen'>
      ...
      <div className='flex flex-col ustify-center items-center mt-4 mb-4 p-4'>
      ...
      <div className='flex flex-col justify-center items-center mb-4 p-4'>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-10">
          ...
          <ul className="flex-1 p-4 border rounded-2xl shadow-md list-disc list-inside pl-5 sm:h-full w-full bg-gray-900 text-white">
